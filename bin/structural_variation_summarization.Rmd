...
#saveRDS(sv_tra_all, file = "/xdisk/mpadi/jiawenyang/result/centrosome_loss/circos/sv_delly_tra.RDS")
...
#saveRDS(sv_others_all, file = "/xdisk/mpadi/jiawenyang/result/centrosome_loss/circos/sv_delly_others.RDS")
```
...
generate_sv_circosplot<-function(sample_id){
  ...
  #Generate plot
  #pdf(file = paste0("/xdisk/mpadi/jiawenyang/result/centrosome_loss/circos/plots/", sample_id, "_CircosPlot.pdf"))
  print(sample_id)
...
#Generate plot
  #pdf(file = "/xdisk/mpadi/jiawenyang/result/centrosome_loss/circos/cn9_cn9r2_2_CircosPlot_common_traslocations.pdf")
  circos.par("start.degree" = 90, "track.height" = 0.25)
  circos.initializeWithIdeogram(species='hg38', chromosome.index = paste0("chr", c(1:22, "X", "Y")))
...
for (file in files_bin_sv_counts){
  #file =  "/xdisk/mpadi/jiawenyang/result/centrosome_loss/circos/CN2_2b_CKDN200005067-1A_H5T7VDSXY_L1_bin_counts.csv"  
...
#pdf(file = "/xdisk/mpadi/jiawenyang/result/centrosome_loss/circos/sv_per_bin_heatmap.pdf", height = 6, width = 9)
Heatmap(mat,
        name = "SV count per \n 10Mb genome",
...
#sv_count_matrix<-sv_count_matrix[,c(1, 3, 4, 7:ncol(sv_count_matrix))]
...
#write.csv(hypermutation_not_in_centromere_regions, file = "/xdisk/mpadi/jiawenyang/result/centrosome_loss/circos/hypermutation_not_in_centromere_regions.csv")
...
#write.csv(hypermutation_in_centromere_regions, file = "/xdisk/mpadi/jiawenyang/result/centrosome_loss/circos/hypermutation_in_centromere_regions.csv")
...
#pdf(file ="/xdisk/mpadi/jiawenyang/result/centrosome_loss/circos/sv_per_bin_hotspot_non_centromeric_region.pdf")
p
#dev.off()
```
...
#pdf(file ="/xdisk/mpadi/jiawenyang/result/centrosome_loss/circos/sv_per_bin_hotspot_in_centromeric_region.pdf")
p
#dev.off()
```
...
#pdf(file ="/xdisk/mpadi/jiawenyang/result/centrosome_loss/circos/sv_per_bin_hotspot.pdf")
p
```
...
#saveRDS(cnv_df, file = "/xdisk/mpadi/jiawenyang/result/centrosome_loss/cnvkit_wgs/cnv_bins_for_heatmap.rds")
```
...
# Plotting dendrogram
#pdf(file = "/xdisk/mpadi/jiawenyang/result/centrosome_loss/cnvkit_wgs/Unsupervised_Hierarchical_clustering_on_samples.pdf")
plot(Hierar_cl)
#dev.off()
```
...
#write.csv(cnv_gain_cytobands, file = "/xdisk/mpadi/jiawenyang/result/centrosome_loss/cnvkit_wgs/xenograft_tumor_consistent_gain_regions.csv")

#Show consistently loss regions
DT::datatable(cnv_loss_cytobands)
#write.csv(cnv_loss_cytobands, file = "/xdisk/mpadi/jiawenyang/result/centrosome_loss/cnvkit_wgs/xenograft_tumor_consistent_loss_regions.csv")
```
...
#pdf(file = "/xdisk/mpadi/jiawenyang/result/centrosome_loss/cnvkit_wgs/cnv_gain_regions.pdf")
...
#pdf(file = "/xdisk/mpadi/jiawenyang/result/centrosome_loss/cnvkit_wgs/cnv_loss_regions.pdf")  
